defmodule DocSpec.Spec.DefinitionDetails do
  @moduledoc """
  The definition or description for a term in a definition list. Equivalent to HTML `<dd>` element.
  ...
  * `id` (required)
  * `type` - Always `"https://alpha.docspec.io/DefinitionDetails"`.
  """

  use DocSpec.Spec.Schema, type: "https://alpha.docspec.io/DefinitionDetails"
