defmodule DocSpec.Spec.DefinitionTerm do
  @moduledoc """
  A term being defined in a definition list. Equivalent to HTML `<dt>` element.
  ...
  * `id` (required)
  * `type` - Always `"https://alpha.docspec.io/DefinitionTerm"`.
  """

  use DocSpec.Spec.Schema, type: "https://alpha.docspec.io/DefinitionTerm"
