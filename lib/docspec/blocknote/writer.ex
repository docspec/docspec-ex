defmodule DocSpec.BlockNote.Writer do
  @moduledoc """
  ...
  alias DocSpec.BlockNote.Writer.Color
  ...
  defmodule State do
    ...
    typedstruct enforce: true do
      ...
      field :extracted_blocks, [BlockNote.Document.content()], default: []
    end
  end
  ...
  @spec write(document :: NLdoc.Spec.Document.t(), opts: [opt()]) ::
          {:ok, [BlockNote.Document.content()]} | error()
  ...
  @spec write_resource({document :: NLdoc.Spec.Document.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Document.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.Paragraph.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Paragraph.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.UnorderedList.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.BulletListItem.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.OrderedList.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.NumberedListItem.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.ListItem.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.BulletListItem.t() | BlockNote.NumberedListItem.t()], State.t()}}
          | error()
  defp write_resource(
    ...
    with {:ok, {bn_texts, state = %State{}}} <-
      ...
      item =
        if state.parent_list_type == :bullet do
          %BlockNote.BulletListItem{
            id: resource.id,
            content: bn_texts,
            children: nested_items
          }
        else
          %BlockNote.NumberedListItem{
            id: resource.id,
            content: bn_texts,
            children: nested_items,
            props:
  ...
  @spec write_resource({resource :: NLdoc.Spec.Image.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Image.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.Heading.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Heading.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.Preformatted.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.CodeBlock.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.BlockQuotation.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Quote.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.Table.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Table.t()], State.t()}} | error()
  defp write_resource(
    ...
    with {:ok, {rows, state}} <-
      ...
      {:ok,
       {[
          %BlockNote.Table{
            id: resource.id,
            content: %BlockNote.Table.Content{rows: normalized_rows}
          }
        ], state}}
      |> add_extracted_blocks()
    end
  ...
  @spec write_resource({resource :: NLdoc.Spec.TableRow.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Table.Content.row()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({resource :: NLdoc.Spec.TableHeader.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Table.Cell.t()], State.t()}} | error()
  defp write_resource(
  ...
  @spec write_resource({text :: NLdoc.Spec.Text.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Text.t()], State.t()}} | error()
  ...
  @spec write_resource({resource :: NLdoc.Spec.Link.t(), State.t(), Context.t()}) ::
          {:ok, {[BlockNote.Link.t()], State.t()}} | error()
  ...
  @spec normalize_table_rows([BlockNote.Table.Content.row()]) :: [
          BlockNote.Table.Content.row()
        ]
  ...
  @spec add_extracted_blocks({[BlockNote.Document.content()], State.t()}) ::
          {[BlockNote.Document.content()], State.t()}
  @spec add_extracted_blocks({:ok, {[BlockNote.Document.content()], State.t()}}) ::
          {:ok, {[BlockNote.Document.content()], State.t()}}
