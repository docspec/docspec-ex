defmodule DocSpec.BlockNote.Writer.Color do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> DocSpec.BlockNote.Writer.Color.nearest(:text, "#d9730d")
      {:ok, "orange"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:background, "#d9730d")
      {:ok, "orange"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:text, "#64473a")
      {:ok, "brown"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:background, "#64473a")
      {:ok, "brown"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:text, {224, 62, 62})
      {:ok, "red"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:background, {224, 62, 62})
      {:ok, "orange"}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:text, "not-a-color")
      {:error, :invalid}

      iex> DocSpec.BlockNote.Writer.Color.nearest(:background, "not-a-color")
      {:error, :invalid}
  """
